...
func SendMessageR(message Prometheus, rwxurl, rddurl, rfsurl, rphone, remail, rgroupid, logsign string) string {
	...
	for _, RMessage := range AlerMessage {
		...
		// 推送消息到企业微信
		SendWorkWechat(beego.AppConfig.String("WorkWechat_AgentID"),beego.AppConfig.String("WorkWechat_AgentSecret"),beego.AppConfig.String("WorkWechat_ToUser"), beego.AppConfig.String("WorkWechat_ToParty"), beego.AppConfig.String("WorkWechat_ToTag"), wxtext, logsign)
