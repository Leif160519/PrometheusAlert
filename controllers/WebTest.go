...
func (c *MainController) AlertTest() {
	...
	case "workwechat":
		...
		ret := SendWorkWechat(beego.AppConfig.Int64("WorkWechat_AgentID"),beego.AppConfig.String("WorkWechat_AgentSecret"),beego.AppConfig.String("WorkWechat_ToUser"), beego.AppConfig.String("WorkWechat_ToParty"), beego.AppConfig.String("WorkWechat_ToTag"), WorkwechatMessage, logsign)
		c.Data["json"] = ret
	case "bddx":
		MobileMessage := "PrometheusAlertCenter测试告警"
